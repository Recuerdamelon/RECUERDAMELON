...
public class TaskService {
    ...
    public TaskService(TaskRepository repository, TaskServiceMapper mapper, UserService service) {
    ...
    //Comente esto para subirlo al git
    public List<Task> findByUserId(Integer integer) {

        return repository.findByUserId(service.findById(integer));
