...
public abstract class AbstactService<E, ID, DTO, REPO extends JpaRepository<E, ID>, MAPPER extends AbstractServiceMapper<E, DTO>>  {
    private final REPO repository;
    private final MAPPER serviceMapper;

    protected AbstactService(REPO repository, MAPPER serviceMapper) {
